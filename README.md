About ldas-tools-framecpp-feedstock
===================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ldas-tools-framecpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ldas-tools-framecpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add ldas-tools-framecpp
# for installing globally
pixi global install ldas-tools-framecpp
```
...
It is possible to list all of the versions of `ldas-tools-framecpp` available on your platform:
...
```
pixi search ldas-tools-framecpp --channel conda-forge
```
